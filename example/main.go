...
import (
	...
	"git.chinawayltd.com/golib/gin-swagger/example/from_request"
	"git.chinawayltd.com/golib/gin-swagger/example/test"
	"git.chinawayltd.com/golib/gin-swagger/example/test3"
)
