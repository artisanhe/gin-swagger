...
import (
	...
	"git.chinawayltd.com/golib/gin-swagger/swagger_to_client"
)
...
func init() {
	...
	cmdClient.Flags().StringVarP(&cmdClientFlagBaseClient, "base-client", "", "git.chinawayltd.com/golib/gin-swagger/swagger_to_client/client", "client name")
